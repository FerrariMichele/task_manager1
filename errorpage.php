...
<body style="background-color: rgb(255, 245, 242);">
    ...
    <div class="container d-flex justify-content-center mt-5">
        <div class="text-center">
            ...
            <h4>No project found or access denied</h4>
            <p class="lead">Don't worry, even the best of us make mistakes!</p>
            <img src="img/sad_tangerine.webp" alt="Funny Error" class="img-fluid mb-4" style="max-width: 400px;">
